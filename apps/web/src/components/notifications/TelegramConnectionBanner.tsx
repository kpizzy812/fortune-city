...
export function TelegramConnectionBanner() {
  ...
  return (
    <div className="bg-gradient-to-r from-blue-900/40 to-purple-900/40 border border-blue-700/40 rounded-lg p-3 mb-4 max-h-[850px]:p-2 max-h-[850px]:mb-2">
      <div className="flex items-center gap-3 max-h-[850px]:gap-2">
        {/* Telegram Icon */}
        <div className="flex-shrink-0">
          <svg className="w-7 h-7 max-h-[850px]:w-5 max-h-[850px]:h-5" viewBox="0 0 24 24" fill="#0088cc">
