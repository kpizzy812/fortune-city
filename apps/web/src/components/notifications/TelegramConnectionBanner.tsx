...
export function TelegramConnectionBanner() {
  ...
  return (
    <div className="bg-gradient-to-r from-blue-900/40 to-purple-900/40 border border-blue-700/40 rounded-lg px-3 py-2 mb-3">
      <div className="flex items-center gap-2">
        ...
        {/* Content — single line */}
        <p className="flex-1 min-w-0 text-sm text-white font-semibold truncate">
          {hasTelegram ? 'Get instant updates in Telegram' : 'Link Telegram for notifications'}
        </p>
        ...
        <a
          ...
          className="px-2.5 py-1 bg-[#0088cc] hover:bg-[#0088cc]/80 text-white rounded text-xs font-semibold transition-colors whitespace-nowrap"
        >
