...
import type { AdminUserListItem, UserSortField, SortOrder } from '@/lib/api';
...
export function UsersTable({ onViewUser }: UsersTableProps) {
  ...
  const SortButton = ({ field, label }: { field: UserSortField; label: string }) => (
    <button
