...
- У каждого устройства есть кап хранилища
- Если не собрать — фарм останавливается
- Капы: 2ч / 6ч / 12ч / 24ч / 48ч (прокачивается)

### Апгрейды хранилища (покупаются за токены)

| Уровень | Кап | Цена |
|---------|-----|------|
| 1 | 2 часа | бесплатно |
| 2 | 6 часов | 5% от депозита |
| 3 | 12 часов | 10% от депозита |
| 4 | 24 часа | 20% от депозита |
| 5 | 48 часов | 35% от депозита |

### Автосбор (модуль)
- Цена: 15% от депозита
- Действие: автоматически собирает при заполнении
- Сгорает: после окончания цикла
